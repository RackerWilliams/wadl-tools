...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
    ...
    <pattern id="References">
        ...
        <rule id="CheckReferences" abstract="true">
            <let name="remoteids" value="                 for                      $refs in tokenize(normalize-space(.),' ')[not(substring-before(.,'#') = '')]                  return                         $refs                 "/>
            <let name="localids" value="                 for                  $refs in tokenize(normalize-space(.),' ')[substring-before(.,'#') = '']                  return                         $refs                 "/>
