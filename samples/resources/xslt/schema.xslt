...
<xslt:stylesheet version="1.0"
            ...
            <head>
                ...
                <xslt:for-each select="//xsdxt:link">
                    <xslt:if test="not(@qname)">
                        <xslt:element name="link">
                            <xslt:if test="@rev">
                                <xslt:attribute name="rev">
                                    <xslt:value-of select="@rev"/>
                                </xslt:attribute>
                            </xslt:if>
                            <xslt:if test="@rel">
                                <xslt:attribute name="rel">
                                    <xslt:value-of select="@rel"/>
                                </xslt:attribute>
                            </xslt:if>
                            <xslt:if test="@href">
                                <xslt:attribute name="href">
                ...
                <xslt:choose>
                    <xslt:when test="xsd:annotation/xsd:appinfo/xsdxt:title">
                        <title>
                            <xslt:value-of select="xsd:annotation/xsd:appinfo/xsdxt:title"/>
                        </title>
                    </xslt:when>
                    <xslt:otherwise>
                        <title>
                            <xslt:value-of select="$defaultTitle"/>
                        </title>
                    </xslt:otherwise>
                </xslt:choose>
                            ...
                            <div class="Extern">
                                <div class="ExternHref">
                                    <xslt:element name="a">
                                        ...
                                        <xslt:attribute name="title">Visit
                                            <xslt:value-of select="@schemaLocation"/>
                                        </xslt:attribute>
                                        <xslt:value-of select="@schemaLocation"/>
                                    </xslt:element>
    ...
    <xslt:template name="NamedElement">
        ...
        <xslt:element name="a">
            <xslt:attribute name="id">
                <xslt:value-of select="$anchorPrefix"/><xslt:value-of select="@name"/>
            </xslt:attribute>
            <!--
                        ...
                        <xslt:for-each select="@*">
                            ...
                            <xslt:if test="local-name(.) != 'name'">
                                <tr>
                                    ...
                                    <td>
                                        <xslt:call-template name="QNameToLink"/>
                                    </td>
                                </tr>
                            </xslt:if>
                        </xslt:for-each>
            ...
            <xslt:when test="contains($qname,':')">
                ...
                <xslt:choose>
                    <xslt:when test="//xsdxt:link[(@qname = $qname) and (@rel = 'schema')]">
                        <xslt:call-template name="Anchor">
                            <xslt:with-param name="href"
                                             select="//xsdxt:link[(@qname = $qname) and (@rel = 'schema')]/@href"/>
                    ...
                    <xslt:when test="$prefix = $targetPrefix">
                        <xslt:call-template name="Anchor">
                            <xslt:with-param name="href">
                                <xslt:call-template name="QNameToLocalAnchor"/>
                            </xslt:with-param>
                            <xslt:with-param name="title" select="concat('See ',$localName)"/>
                        </xslt:call-template>
                    </xslt:when>
                    <xslt:when test="$prefix = $schemaPrefix">
                        <xslt:call-template name="Anchor">
                            <xslt:with-param name="href">
                                <xslt:call-template name="QNameToXSDAnchor"/>
                            </xslt:with-param>
                            <xslt:with-param name="title" select="concat('See ',$localName)"/>
                        </xslt:call-template>
                    </xslt:when>
                    <xslt:otherwise>
                        <xslt:call-template name="Anchor">
                            <xslt:with-param name="href">
                                <xslt:call-template name="QNameToForeignAnchor"/>
                            </xslt:with-param>
                            <xslt:with-param name="title" select="concat('See ',$localName)"/>
                        </xslt:call-template>
                    </xslt:otherwise>
        ...
        <xslt:if test="namespace-uri(..) = $schemaNamespace">
            <xslt:choose>
                <xslt:when test="(local-name(.) = 'type') or
                         (local-name(.) = 'base') or
                         (local-name(.) = 'itemType')">
                    <xslt:call-template name="LocalTypeAnchor">
                        <xslt:with-param name="localName" select="$localName"/>
                    </xslt:call-template>
                </xslt:when>
                <xslt:when test="local-name(.) = 'ref'">
                    <xslt:call-template name="LocalRefAnchor">
                        <xslt:with-param name="localName" select="$localName"/>
                    </xslt:call-template>
                </xslt:when>
            </xslt:choose>
    ...
    <xslt:template name="LocalRefAnchorBuilder">
        ...
        <xslt:choose>
            ...
            <!--
                ...
                included...
            -->
            <xslt:when test="count(/xsd:schema/xsd:include) = 1">
                <xslt:value-of
                        select="concat(/xsd:schema/xsd:include/@schemaLocation,'#',$refPrefix,$localName)"/>
            </xslt:when>
        </xslt:choose>
    </xslt:template>
        ...
        <xslt:choose>
            ...
            <xslt:when
                ...
                /xsd:schema/xsd:simpleType[@name = $localName]"
                    >
                <xslt:value-of select="concat('#',$typePrefix,$localName)"/>
            </xslt:when>
            <!--
            ...
            -->
            <xslt:when
                    test="count(/xsd:schema/xsd:include) = 1">
                <xslt:value-of
                        select="concat(/xsd:schema/xsd:include/@schemaLocation,'#',$typePrefix,$localName)"/>
            </xslt:when>
